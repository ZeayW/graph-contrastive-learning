...
def train(options):
    ...
    for num_input in range(start_input, options.num_input + 1):
        ...
        origin_file = os.path.join(data_path, 'i{}/old_origin.pkl'.format(num_input))
        aug_files = [os.path.join(data_path, 'i{}/old_aug{}.pkl'.format(num_input, i)) for i in range(start_aug, 4)]
