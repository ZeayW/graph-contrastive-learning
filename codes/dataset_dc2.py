...
import os
import random
from util.dc_verilog_parser2 import DcParser
...
def parse_single_file(parser,filename,label,label2id):
    ...
    print("PI position",graph.ndata['position'][PIs])
    print("PO position",graph.ndata['position'][POs])
    return graph
